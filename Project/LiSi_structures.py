...
def make_Li_filled_unitcell(write_file=False):
    ...
    if write_file : write(structures_folder_path + 'Li_filled_unitcell.cif', unitcell)
...
def make_unitcell_central_Li(write_file=False):
    ...
    if write_file : write(structures_folder_path + 'unitcell_central_Li.cif', unitcell)
    return Struc(ase2struc(unitcell))
...
def make_unitcell_neighbor_central_Li(write_file=False):
    ...
    if write_file : write(structures_folder_path + 'unitcell_neighbor_central_Li.cif', unitcell)
    return Struc(ase2struc(unitcell))
...
def make_2x2x2_supercell_1x1x1_central_Li(write_file=False):
    ...
    if write_file : write(structures_folder_path + '2x2x2_supercell_1x1x1_central_Li.cif', supercell)
...
def make_2x2x2_supercell_1x1x1_neighbor_central_Li(write_file=False):
    ...
    if write_file : write(structures_folder_path + '2x2x2_supercell_1x1x1_neighbor_central_Li.cif', supercell)
    return Struc(ase2struc(supercell))
...
def make_3x3x3_supercell_central_Li(write_file=False):
    ...
    if write_file : write(structures_folder_path + '3x3x3_supercell_central_Li.cif', supercell)
    return Struc(ase2struc(supercell))
...
def make_3x3x3_supercell_neighbor_central_Li(write_file=False):
    ...
    if write_file : write(structures_folder_path + '3x3x3_supercell_neighbor_central_Li.cif', supercell)
    return Struc(ase2struc(supercell))
